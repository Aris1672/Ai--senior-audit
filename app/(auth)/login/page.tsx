    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{ fontSize: "22px", fontWeight: "700", color: "#e8edf8", marginBottom: "6px" }}>
        ...
        {/* Title */}
        <h1 style={{
          fontSize: "20px", fontWeight: "600", color: "#e8edf8",
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={{ display: "block", fontSize: "13px", color: "#7a90c0", marginBottom: "8px" }}>
            Email
          </label>
          <input
            type="email"
        ...
        <div style={{ marginTop: "24px", textAlign: "center", fontSize: "12px", color: "#3d4f7a" }}>
